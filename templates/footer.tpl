    ...
    <script src="ressources/plugins/jquery-spinner/js/jquery.spinner.js"></script>
    <!-- Bootstrap Tags Input Plugin Js -->
    <script src="ressources/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js"></script>
    <!-- noUISlider Plugin Js -->
    <script src="ressources/plugins/nouislider/nouislider.js"></script>
    ...
    <script src="ressources/js/pages/forms/advanced-form-elements.js"></script>
