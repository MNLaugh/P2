<?php
/* Smarty version 3.1.30, created on 2017-02-18 10:46:19
  from "C:\wamp64\www\DISII\templates\footer.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58a825fb946352_12904278',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a2793b0d56473320742c438ee6ed2fcb7b6de207' => 
    array (
      0 => 'C:\\wamp64\\www\\DISII\\templates\\footer.tpl',
      1 => 1487145413,
      2 => 'file',
    ),
  ),
...
function content_58a825fb946352_12904278 (Smarty_Internal_Template $_smarty_tpl) {
?>
    <!-- Jquery Core Js -->
    <?php echo '<script'; ?>
...
>
    ...
    <?php echo '<script'; ?>
 src="ressources/plugins/bootstrap-notify/bootstrap-notify.js"><?php echo '</script'; ?>
>
...
>
    <!-- Dropzone Plugin Js -->
    <?php echo '<script'; ?>
 src="ressources/plugins/dropzone/dropzone.js"><?php echo '</script'; ?>
>
    <!-- Jquery CountTo Plugin Js -->
    <?php echo '<script'; ?>
 src="ressources/plugins/jquery-countto/jquery.countTo.js"><?php echo '</script'; ?>
>

    <!-- Morris Plugin Js 
    <?php echo '<script'; ?>
 src="ressources/plugins/raphael/raphael.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ressources/plugins/morrisjs/morris.js"><?php echo '</script'; ?>
>-->
...
>
    ...
    <?php echo '<script'; ?>
 src="ressources/plugins/multi-select/js/jquery.multi-select.js"><?php echo '</script'; ?>
>
    <!-- Jquery Spinner Plugin Js -->
    <?php echo '<script'; ?>
 src="ressources/plugins/jquery-spinner/js/jquery.spinner.js"><?php echo '</script'; ?>
>
    <!-- Bootstrap Tags Input Plugin Js -->
    <?php echo '<script'; ?>
 src="ressources/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js"><?php echo '</script'; ?>
>
    <!-- noUISlider Plugin Js -->
    <?php echo '<script'; ?>
 src="ressources/plugins/nouislider/nouislider.js"><?php echo '</script'; ?>
>
    <!-- Flot Charts Plugin Js 
    <!- ChartJs
    <?php echo '<script'; ?>
 src="ressources/plugins/chartjs/Chart.bundle.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="plugins/flot-charts/jquery.flot.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="plugins/flot-charts/jquery.flot.resize.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="plugins/flot-charts/jquery.flot.pie.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="plugins/flot-charts/jquery.flot.categories.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="plugins/flot-charts/jquery.flot.time.js"><?php echo '</script'; ?>
>
    -->
...
>
    <?php echo '<script'; ?>
 src="ressources/js/pages/ui/notifications.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ressources/js/script.js"><?php echo '</script'; ?>
>
</BODY>
</HTML>
<?php }
